        ...
        <div className="max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
           ...
           <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
              ...
              <div className="flex flex-col items-center text-center mb-10">
                 ...
                 <h1 className="text-3xl font-black uppercase tracking-tight text-slate-900">Welcome Back</h1>
                 <p className="text-slate-400 text-sm mt-2">Log in to your CricZone account to continue</p>
              </div>
              ...
              <form className="flex flex-col gap-6">
                 ...
                 <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center ml-1">
                       ...
                       <a href="#" className="text-[10px] font-black uppercase tracking-widest text-[#c5a564] hover:underline">Forgot?</a>
                    </div>
                    <div className="relative group">
                 ...
                 <button className="group relative w-full bg-slate-900 text-white p-5 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-black active:scale-[0.98] transition-all flex items-center justify-center gap-3 overflow-hidden shadow-xl shadow-slate-900/20">
                    <span className="relative z-10 transition-transform group-hover:translate-x-1">Log In</span>
           ...
           <p className="text-center mt-10 text-slate-400 text-sm font-medium">
              Don't have an account? <Link to="/signup" className="text-[#c5a564] font-black uppercase tracking-widest text-xs hover:underline ml-1">Sign Up</Link>
           </p>
        </div>
      </main>
    </div>
